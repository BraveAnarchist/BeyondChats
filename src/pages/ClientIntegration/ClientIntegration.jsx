...
export default function ClientIntegration() {
  ...
  return (
    <>
      <Chatbot />
      <h1
        style={{ textAlign: "center", marginTop: "8vh", marginBottom: "4vh" }}
      >
        Translator
      </h1>
      <div style={{ margin: "0 auto", width: "80%" }}>
        ...
        <select
          name=""
          value={inpL}
          onChange={(e) => setInpL(e.target.value)}
          id="from"
        >
          {lang.map((ele, idx) => {
            return (
        ...
        <input
          type="text"
          style={{ width: "60%", border: "solid black 2px" }}
          value={text}
        ...
        <select
          name=""
          value={outL}
          onChange={(e) => setOutL(e.target.value)}
          id="to"
        >
          {lang.map((ele, idx) => {
            return (
        ...
        <textarea
          style={{ border: "2px solid black", width: "100%", marginTop: "7vh" }}
          name=""
          value={output}
          id=""
        ></textarea>
